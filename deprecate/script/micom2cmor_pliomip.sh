...
CASENAME=${1:-NAER1850CNOC_f19_g16_06}
...
GROUP=${5:-ALL}        # selection of groups e.g. "FX-M3D-MXD-DAY"
...
set_time_range() 
{
  YEAR11=`ls $BASEDIR/$CASENAME/ocn/hist | grep "\.$1\." | \
  ...
  #
  YEARNN=`ls $BASEDIR/$CASENAME/ocn/hist | grep "\.$1\." | \
