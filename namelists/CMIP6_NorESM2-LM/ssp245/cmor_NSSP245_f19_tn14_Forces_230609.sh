...
# part 1
#----------------
CaseName=NSSP245_f19_tn14_Forces_230609
real=1
physics=4
forcing=1
init=1
...
runcmor -c=$CaseName -m=$model -e=$expid -v=$version -r=$real -p=$physics -f=$forcing -i=$init -yrs1="${years1[*]}" -yrs2="${years2[*]}" -s=2 -mpi=DMPI
#---
fi
#---
