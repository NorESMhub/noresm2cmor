...
then
#----------------
# piClim-histghg, ensemble 1
#----------------
CaseName=NFHISTnorpibc_ghgonly_f19_20190810
real=1
...
then
#----------------
# piClim-histghg, ensemble 2
#----------------
CaseName=NFHISTnorpibc_ghgonly_02_f19_20190909
real=2
years1=(1849 $(seq 1860 10 1940))
years2=(1859 $(seq 1869 10 1949))
years1+=($(seq 1950 10 2000) 2010)
...
then
#----------------
# piClim-histghg, ensemble 3
#----------------
CaseName=NFHISTnorpibc_ghgonly_03_f19_20190923
real=3
years1=(1849 $(seq 1860 10 1940))
years2=(1859 $(seq 1869 10 1949))
years1+=($(seq 1950 10 2000) 2010)
...
#----------------
CaseName=NFHISTnorpibc_ghgonly_f19_20191208
real=1
physics=2
...
#----------------
CaseName=NFHISTnorpibc_ghgonly_02_f19_20200118
real=2
physics=2
years1=(1849 $(seq 1860 10 2000) 2010)
years2=(1859 $(seq 1869 10 2009) 2014)
...
then
#----------------
# piClim-histghg, r3i1p2f1
#----------------
CaseName=NFHISTnorpibc_ghgonly_03_f19_20200118
real=3
physics=2
years1=(1849 $(seq 1860 10 2000) 2010)
years2=(1859 $(seq 1869 10 2009) 2014)
