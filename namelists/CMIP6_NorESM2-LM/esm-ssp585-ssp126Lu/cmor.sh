...
then
#----------------
# esm-ssp585-ssp126Lu, common variables
#----------------
#CaseName=b.e21.NSSP585frc2.f19_tn14.CMIP6-SSP5-8.5-SSP1-2.6Lu.001
years1=(2015 $(seq 2021 10 2091))
years2=(2020 $(seq 2030 10 2100))

rm -f $CMOR_ROOT/bin/filelist_b.e21.NSSP585frc2.f19_tn14.CMIP6-SSP5-8.5-SSP1-2.6Lu.001
...
#----------------
# esm-ssp585-ssp126Lu, LUMIP variables
#----------------
#CaseName=b.e21.NSSP585frc2.f19_tn14.CMIP6-SSP5-8.5-SSP1-2.6Lu.001
years1=(2015 $(seq 2021 10 2091))
years2=(2020 $(seq 2030 10 2100))
