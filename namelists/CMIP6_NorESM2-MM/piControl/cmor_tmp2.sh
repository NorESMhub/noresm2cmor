...
years1=(1300)
years2=(1309)
#years1=($(seq 1300 10 1440))
#years2=($(seq 1309 10 1449))

runcmor -c=$CaseName -m=$model -e=$expid -v=$version -r=$real -yrs1="${years1[*]}" -yrs2="${years2[*]}" -p=NS9560KFRAM 
#---
fi
#---
