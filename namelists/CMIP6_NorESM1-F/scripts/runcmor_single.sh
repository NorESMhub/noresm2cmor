...
nmlroot=../namelists/CMIP6_NorESM1-F/${expid}/${version}
logroot=../logs/CMIP6_NorESM1-F/${expid}/${version}
...
for (( i = 0; i < ${#years1[*]}; i++ )); do
    ...
    cp CMIP6_NorESM1-F/${expid}/template/exp${CaseName}.nml \
    ...
    sed -i "s/yearn         =.*/yearn         = ${year2},/g" \
        CMIP6_NorESM1-F/${expid}/${version}/exp.nml
    mv CMIP6_NorESM1-F/${expid}/${version}/exp.nml CMIP6_NorESM1-F/${expid}/${version}/exp_${year1}-${year2}${real}.nml
